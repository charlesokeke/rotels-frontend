          ...
          <GridList cellHeight={160} className={classes.gridList} cols={2.5}>
            {photos.map((element,index) => {
               return <GridListTile key={index}>
                <img src={ `https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${element.photo_reference}&key=AIzaSyDBUOAf-TRFXcQkDLaGk4kiQZ7ZJSyJzJc` } alt={"pic"} />
              </GridListTile>
            })}
          </GridList>
        </div>
