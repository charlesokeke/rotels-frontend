            ...
            <Grid item xs container direction="column" spacing={16}>
              <Grid item xs>
                <Typography variant="subtitle1">
                 ...
                 <RatingComponent  starCount={Math.round(rating)} name={'star'}/>
                <Typography>{text}</Typography>
              </Grid>
            </Grid>
            <Grid item>
            <Badge badgeContent={`${rating}.0`} className={classes.margin} color="primary">
              <Typography className={classes.padding} color="primary"></Typography>
          </Badge>
