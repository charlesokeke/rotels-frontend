...
class  RenderMap extends React.PureComponent {
  ...
  initMap = () => {
            ...
            this.calculateAndDisplayRoute(directionsService, directionsDisplay,rightPanel,mapReference);
      }

  calculateAndDisplayRoute =   (directionsService, directionsDisplay, rightPanel,  mapReference) => {
