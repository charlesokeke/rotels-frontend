...
function MediaCard(props) {
  const { classes, image, name, address,user_rating, openHours, rating ,getPlaceDetails} = props;
    ...
    <Card className={classes.card}>
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography component="p" color="secondary" size="small" className={classes.lightgreen}>
